	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						...
						//(currentChar >= '0' && currentChar <= '9' )) {	// Check for 0-9 - I removed this since it should be alphabetic
					nextState = 1;
			...
			case 1: 
				...
				//  2: a minus sign, underscore, and a period that transitions to state 2 
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '-' || currentChar == '_' ) {		// I added to check for minus sign, underscore, and a period
					nextState = 2;
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += 
					"A UserName character may only contain the characters A-Z, a-z, 0-9, minus signs, underscores, or periods.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
